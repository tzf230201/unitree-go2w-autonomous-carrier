...
URDF is rendered from `om6dof_description/urdf/om6dof.urdf.xacro` at startup
...
def render_chain_urdf(
    ...
    kinematics source shared with ordinary MoveGroup planning."""
